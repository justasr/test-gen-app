<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"> <?php echo lang('heading_show_tests_taken_surveys'); ?></h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo lang('heading_show_tests_taken_surveys'); ?>
            </div>
            <!-- /.panel-heading -->
...
<script type="text/javascript" charset="utf-8">
    $(document).ready(function() {
        $('#dataTables-show-tests').dataTable( {
            ...
            "sAjaxSource": "<?php echo base_url(); ?>user/show_tests_taken_surveys_ajax"
        } );
    } );
</script>