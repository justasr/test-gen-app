<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><?php echo lang('header_exam_test_take'); ?></h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
    ...
    <div class="col-lg-6">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo lang('header_exam_test_take'); ?>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        <?php echo form_open( "test/take_exam/?id=".$output['take_test_info']['test_info']['idtest'], array( 'role'=>'form' ) ); ?>
