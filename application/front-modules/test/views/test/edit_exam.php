    ...
    <div class="col-lg-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-6">
                        <?php echo form_open( base_url()."test/edit_exam/?id=".$output['test_info']['idtest'],array( 'role'=>'form' ) ); ?>
                        ...
                        <div class="form-group">
                            <label> <?php echo lang("l_test_question_pass_count"); ?>:</label>
                            <input  value="<?php echo $output['test_info']['test_question_pass_count']; ?>" type="text"  value="" name="test_question_pass_count"  class="form-control">
                        </div>
