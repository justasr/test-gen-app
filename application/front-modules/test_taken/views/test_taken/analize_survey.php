<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><?php echo lang('header_survey_analize'); ?></h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
...
<div class="row">
    <div class="col-lg-6">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo lang('header_survey_analize'); ?>
            </div>
            <div class="panel-body">
            ...
            <div class="panel-body">
                ...
                <?php foreach($output['take_test_analitics']['questions_with_answers'] as $question_id => $question ): ?>
                    ...
                    <script type="text/javascript">
                        var_data_json_<?php echo $question_id;?> = $.parseJSON('<?php echo json_encode($pollDATA); ?>');
                        $( document ).ready(function() {
                            Morris.Bar({
                                element: 'poll-statistics-<?php echo $question_id;?>',
                                data: [ var_data_json_<?php echo $question_id;?>['data'] ],
                                xkey: '100',
                                ymax: 100,
                                ykeys: var_data_json_<?php echo $question_id;?>['ykeys'],
                                labels:  var_data_json_<?php echo $question_id;?>['labels']
                            });
                        });
